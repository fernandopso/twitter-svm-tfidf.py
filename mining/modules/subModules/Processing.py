#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Nome do arquivo: Processing.py
# Direitos: Universidade Federal de Lavras - Departamento Ciência da Computação
# Informações sobre licença, veja LICENSE.TXT 
# Natural Language Toolkit: RSLP Stemmer 
# URL: <http://www.nltk.org/> 
# Necessario instalar o python-jsonpickle para o json
